...
export default function ReportBulananPage() {
  ...
  return (
    <ReportPage user={profile} title="Report Bulanan" initialTab="qc">
      {(currentTab) => {
        if (currentTab === "qc") {
          if (qcRecords.length === 0) {
            return <EmptyState title="Belum ada data bulanan QC." description="Data akan muncul setelah pemeriksaan dilakukan." />;
          }
        ...
        if (suhuRecords.length === 0) {
          return <EmptyState title="Belum ada data bulanan suhu." description="Data suhu akan muncul setelah pengukuran dilakukan." />;
        }
